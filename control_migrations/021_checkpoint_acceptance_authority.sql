CREATE TABLE checkpoint_acceptance_launches (
    ...
    expected_source_sha256 TEXT NOT NULL CHECK (length(expected_source_sha256)=64),
    observed_source_sha256 TEXT,
    source_attestation_state TEXT NOT NULL DEFAULT 'PENDING'
        CHECK (source_attestation_state IN ('PENDING','MATCHED','MISMATCH')),
