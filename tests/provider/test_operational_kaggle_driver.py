...
def _fm14_checkpoint_status(request: DriverRequest) -> dict[str, Any]:
    ...
    status = {
        ...
        "status_input": {
            "provider_ref": "unit-test-owner/mdh-acc-status",
            "exact_version_ref": "unit-test-owner/mdh-acc-status/1",
            "claim_sha256": "c" * 64,
            "content_tree_sha256": "d" * 64,
            "status_config_sha256": "e" * 64,
            "status_helper_sha256": "f" * 64,
            "cleanup_receipt_sha256": "1" * 64,
            "cleaned": True,
            "resource_lease": {
                "lease_id": "11111111-1111-4111-8111-111111111111",
                "resource_kind": "kaggle_notebook",
                "resource_ref": provider_ref,
                "holder_id": str(request.task_run_id),
                "lease_until": "2026-08-11T00:15:00Z",
                "epoch": 1,
                "released": True,
            },
        },
        "runtime_observation": {
            ...
            "latest_progress": {"completed_steps": 3},
            "event_counts": {
                "runtime.started": 1,
                "runtime.progress": 1,
                "runtime.heartbeat": 1,
            ...
            "event_uids": [f"event-{index:02d}" for index in range(7)],
            "event_receipt_sha256s": [f"{index:x}" * 64 for index in range(7)],
            "last_local_sequence": 7,
