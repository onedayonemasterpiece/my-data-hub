...
| R02 | R02 | integration/provider-run-product | integrated | pending | serial integration | schema/provider metadata tests + full suite |
| R03 | R03 | integration/provider-run-product | integrated | pending | serial integration | status/list/download tests + full suite |
