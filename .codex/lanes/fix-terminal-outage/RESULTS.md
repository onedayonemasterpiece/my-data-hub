...
- Implementation commit: `c07a17dfac42e72208ca1fe2e48e4b99a8d00c37`
...
- Focused master/runtime/provider suite: `31` tests passed.
- Full `pytest -q`: passed with one opt-in test skipped.
- `python -m compileall -q src tests`: passed.
- `ruff check src tests scripts`: passed.
- `scripts/create_notebooks.py --check`: no drift.
- Repository validator: `2,877` checks, zero errors, `ok: true`.
