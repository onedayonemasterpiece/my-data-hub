...
BEGIN
    FOREACH role_name IN ARRAY ARRAY[
        ...
        'mdh_migration_operator', 'mdh_backup', 'mdh_monitoring'
    ] LOOP
...
BEGIN
    ...
    EXECUTE format('GRANT CONNECT ON DATABASE %I TO mdh_migrator, mdh_application, mdh_orchestrator, mdh_connector_intake, mdh_mcp_reader, mdh_mcp_editor, mdh_migration_operator, mdh_backup, mdh_monitoring', current_database());
...
GRANT INSERT, UPDATE ON migration.export_batch, migration.export_batch_kind,
    ...
    migration.reconciliation_finding, migration.cutover_receipt TO mdh_migration_operator;
