...
def build_authorization_runtime() -> AuthorizationRuntime:
    ...
    if _boolean("MY_DATA_HUB_OAUTH_CHATGPT_CIMD_ENABLED"):
        ...
        extra_scopes_raw = _csv(
            "MY_DATA_HUB_OAUTH_CHATGPT_EXTRA_SCOPES",
            (),
            maximum_values=32,
        )
        extra_scopes = frozenset(extra_scopes_raw)
        ...
        combined_scopes = cimd_scopes | extra_scopes
        client_metadata_resolver = ChatGPTClientMetadataResolver(allowed_scopes=combined_scopes)
